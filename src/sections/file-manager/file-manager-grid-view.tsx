...
// types
// import { any } from 'src/types/file';
// hooks
import { useBoolean } from 'src/hooks/use-boolean';
// components
import Iconify from 'src/components/iconify';
// import { TableProps } from 'src/components/table/use-table';
//
  ...
  return (
    <>
      <Box ref={containerRef}>
        <FileManagerPanel
          title="Folders"
          subTitle={`${data.filter((item:any) => item.type === 'folder').length} folders`}
        ...
        <FileManagerPanel
          title="Files"
          subTitle={`${data.filter((item:any) => item.type !== 'folder').length} files`}
