...
// _mock
import { TOUR_SERVICE_OPTIONS } from "src/_mock/_tour";
// types
...
import { varTranHover } from "src/components/animate/variants/transition";
    ...
    >
      {[
        ...
        },
        {
          label: "Contact name",
          value: tourGuides
            .map((tourGuide: any) => tourGuide.phoneNumber)
            .join(", "),
