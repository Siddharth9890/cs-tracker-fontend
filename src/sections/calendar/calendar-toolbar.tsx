...
import  {CustomPopover, usePopover } from 'src/components/custom-popver';
...
export default function CalendarToolbar({
  ...
  const selectedItem = VIEW_OPTIONS.filter((item:any) => item.value === view)[0];
