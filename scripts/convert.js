  ...
  content: [
    {
      ...
      contentCompletedQuestions: 28,
      categoryList: [
        {
          categoryId: 4,
          categoryName: "Know Basic Maths",
          categoryTotalQuestions: 7,
          categoryCompletedQuestions: 6,
          questionList: [
            {
    ...
    },
    {
      ...
      contentCompletedQuestions: 5,
      categoryList: [
        {
          categoryId: 1,
          categoryName: "Sorting-I",
          categoryTotalQuestions: 3,
          categoryCompletedQuestions: 3,
          questionList: [
            {
      ...
      categoryList: [
        {
          ...
          questionList: [
            ...
            },
            {
              ...
              isBookmarked: true,
              userNotes:
                "check the solution it should be if nums are not equal then incre i and replace them. but if are equal j increments and then replacing the duplicate one",
              questionIndex: 3,
            ...
            },
            {
              ...
              isBookmarked: true,
              userNotes:
                "in leetcode it is right rotation and in gfg it is left rotation so sequence changes.\n// leet code:- [1,2,3,4,5,6,7]=>[7,6,5,4,3,2,1]=> [5,6,7,1,2,3,4]\n        // gfg:- [1,2,3,4,5,6,7]=> [2,1,7,6,5,4,3] => [3,4,5,6,7,1,2]",
              questionIndex: 4,
